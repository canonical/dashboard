...
> ```
> Packed dashboard_0.42_amd64.rock
> ```
...
rockcraft.skopeo --insecure-policy copy --dest-tls-verify=false \
  oci-archive:dashboard_0.42_amd64.rock \
  docker://localhost:32000/dashboard:0.42
juju deploy ./charm/dashboard_ubuntu-22.04-amd64.charm \
  --resource django-app-image=localhost:32000/dashboard:0.42
```
